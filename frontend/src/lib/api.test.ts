...
test("every route: method + path + body locked", async () => {
  const cases: Array<[() => Promise<unknown>, string, string, unknown]> = [
    ...
    [() => api.uvcCameras(), "GET", "/api/vision/uvc", undefined],
    [() => api.uvcControls("0x231000"), "GET", "/api/vision/uvc/0x231000/controls", undefined],
    [() => api.uvcSetControl("0x231000", "brightness", 90), "PUT", "/api/vision/uvc/0x231000/controls", { key: "brightness", value: 90 }],
    [() => api.uvcReset("0x231000"), "POST", "/api/vision/uvc/0x231000/reset", undefined],
    [() => api.visionResetSettings("science"), "DELETE", "/api/vision/settings/science", undefined],
