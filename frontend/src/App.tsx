  ...
  return (
    <ErrorBoundary>
      <div className="console">
        ...
        {ui.view === "priming" && <PrimingView status={status} gates={g} call={call} order={ui.order.priming} sizes={ui.sizes.priming} onOrder={setOrder("priming")} onResize={setResize("priming")} />}
